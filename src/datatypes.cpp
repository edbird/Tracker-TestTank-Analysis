...
void TestTankStorage_init(TestTankStorage * const testtankstorage_)
{
    ...
    store.anode_average_histo = (TH1F*)0;
    store.anode_differential_histo = (TH1F*)0;
    store.anode_average_differential_histo = (TH1F*)0;
...
void TestTankStorage_setbranchaddress(TestTankStorage * const testtankstorage_, TTree * const tree_, bool mc = false)
{
    ...
    // added 2018-02-13
    //t->SetBranchAddress("differential_histo", &store.differential_histo);
...
void TestTankStorage_branch(TestTankStorage * const testtankstorage_, TTree * const tree_, bool mc = false)
{
    ...
    t2->Branch("anode_average_histo", &store.anode_average_histo);
    t2->Branch("anode_differential_histo", &store.anode_differential_histo);
    t2->Branch("anode_average_differential_histo", &store.anode_differential_histo);
